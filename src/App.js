...
const NODE_URL = "https://api.exlo.no/api/latest-block";
const targetBlockheight = 8750000;
const visualTargetBlockheight = "8,750,000";
const estimatedDate = "SAT March 5 2022 16:00:00 GMT+0100 (Central European Summer Time)"; // showed while calculating
const teasingMessage = "IT'S HAPPENING! Etho Protocol v2.0 (Phoenix)";
const successMessage = "Oh Yeah! Etho Protocol v2.0 (Phoenix) is live!";
